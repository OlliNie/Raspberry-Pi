...
#libssl1.0-dev is now libssl1.1 alsolibgcrypt20-dev is now libgcrypt20
install_dependencies() {
  sudo apt-get update
  sudo apt-get -y install git gcc cmake build-essential libsqlite3-dev libcurl4-openssl-dev libssl1.1 libfaad-dev libsoup2.4-dev libgcrypt20 libgstreamer-plugins-bad1.0-dev gstreamer1.0-plugins-good libasound2-dev sox gedit vim python3-pip
