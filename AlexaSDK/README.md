...
It took me some research to figure this all out, and the problem was that alot of the information was scattered all around the web and not in a single location. This inspired me to create this write up in order to assist others get Alexa voice services running on their Raspberry Pi.
